...
class ObserverOptionsBuilder {
    ...
    useOldValue() {
        if (!this._options.attributes && !this._options.characterData) {
            throw new Error('ObserverOptionsBuilder.useOldValue() требует предварительного вызова attributes() и/или text()');
        }
    ...
    build() {
        if (!this._options.childList &&
            ...
            throw new Error('ObserverOptionsBuilder.build() требует включить хотя бы один тип наблюдения: childList(), attributes() или text()');
        }
        return this._options;
    }
}
export default ObserverOptionsBuilder;
//# sourceMappingURL=ObserverOptionsBuilder.mjs.map