...
declare class Observer extends MutationObserver {
     ...
     * @protected
     */
    protected _autoDisconnectLock: boolean;
    /**
     ...
     * @protected
     */
    protected _autoDisconnectTimer?: ReturnType<typeof setTimeout>;
    /**
     ...
     * @protected
     */
    protected _autoDisconnectPromiseResolve?: Function;
    /**
     *
     ...
     */
    autoDisconnect(ms: number, onDisconnect?: () => void): Promise<void>;
    /**
